...
/*  Framework used from Lecture 8 Demo
    Some assistance from Andres Rios
*/
        ...
        if (pva == true){
           // ai=true; //keeps ai
            ...
            for (int i = 0; i < grid.size(); i++) {
             ...
             if(mx>-0.8&& mx< -.1 &&my <0.8 && my> -0.8){ //Left Button

                    pva = true; //activates player vs computer
                    ai=true;
                    }
    }
       // pva=false;
           ...
           if(pvp=true){
            ...
            if(mx > .1 && mx <.8 && my < .8 && my > -.8){ //activates right button
      //  cout <<"Poke";
            pvp = true; // no ai
                ai=false;
        }
